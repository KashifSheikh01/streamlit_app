...
with col4:    
    st.metric(label="Avg Rating", value=f"{avg_rating}")
...
fig_customer_sales = px.pie(sales_by_customer_type, names='Customer type',
 values="Total", title="Sales By Customer Type", color="Customer type",
...
fig_payment_sales = px.pie(
    sales_by_payment_type, names='Payment', values="Total", title="Sales By Payment Methods",
